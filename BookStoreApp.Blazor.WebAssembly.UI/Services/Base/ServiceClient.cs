...
namespace BookStoreApp.Blazor.WebAssembly.UI.Services.Base
{
    ...
    public partial class BookCreateDTO
    {
        ...
        [Newtonsoft.Json.JsonProperty("summmary", Required = Newtonsoft.Json.Required.Always)]
    ...
    public partial class BookDetailsDTO
    {
        ...
        [Newtonsoft.Json.JsonProperty("summmary", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Summmary { get; set; }
